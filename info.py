...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001870142488').split()]
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Blaster_Originals')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001870142488'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+kfsE4hjv2eMyNDE9')
