...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/Blaster_Originals")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
                ...
                temp.MELCOW['welcome'] = await message.reply_video(
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup(
                                                                         [[
                                                                           ...
                                                                           InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/ShinobiUnder")
                                                                         ]]
                                                 ),
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('Support Group', url="https://t.me/Blaster_Movie_Request"),
            InlineKeyboardButton('Owner', url="https://t.me/Blaster_Originals")
        ],[
